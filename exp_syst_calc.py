def calc(x):
    ver_var_Sams_A3 = {0:0.1, 1:1, 2:0, 3:0, 6:0, 7:1, 8:0}
    ver_var_Sams_A5 = {0:0.1, 1:1, 2:0, 3:0, 6:1, 7:1, 8:0}
    ver_var_Sams_S7 = {0:0.5, 1:1, 2:0, 3:0, 6:0, 7:1, 8:0}
    ver_var_Sams_S8 = {0:0.3, 1:1, 2:0, 3:0, 6:1, 7:1, 8:0}
    ver_var_Iphone_6S = {0:0.1, 1:0, 2:1, 3:0, 6:0, 7:0, 8:1}
    ver_var_Iphone_7 = {0:0.1, 1:0, 2:1, 3:0, 6:1, 7:0, 8:1}
    ver_var_Len_K5 = {0:0.1, 1:0, 2:0, 3:1, 6:0, 7:1, 8:0}
    ver_var_Len_K6 = {0:0.1, 1:0, 2:0, 3:1, 6:1, 7:1, 8:0}
    ver_var_Len_X = {0:0.1, 1:0, 2:0, 3:1, 6:0, 7:1, 8:0}
    ver_var_Len_Z = {0:0.1, 1:0, 2:0, 3:1, 6:1, 7:1, 8:0}
