def calc(x):
    ver_var_Sams_A3 = {0:0.1, 1:1, 2:0, 3:0, 4:0, 5:1, 6:0}
    ver_var_Sams_A5 = {0:0.1, 1:1, 2:0, 3:0, 4:1, 5:1, 6:0}
    ver_var_Sams_S7 = {0:0.5, 1:1, 2:0, 3:0, 4:0, 5:1, 6:0}
    ver_var_Sams_S8 = {0:0.3, 1:1, 2:0, 3:0, 4:1, 5:1, 6:0}
    ver_var_Iphone_6S = {0:0.1, 1:0, 2:1, 3:0, 4:0, 5:0, 6:1}
    ver_var_Iphone_7 = {0:0.1, 1:0, 2:1, 3:0, 4:1, 5:0, 6:1}
    ver_var_Len_K5 = {0:0.1, 1:0, 2:0, 3:1, 4:0, 5:1, 6:0}
    ver_var_Len_K6 = {0:0.1, 1:0, 2:0, 3:1, 4:1, 5:1, 6:0}
    ver_var_Len_X = {0:0.1, 1:0, 2:0, 3:1, 4:0, 5:1, 6:0}
    ver_var_Len_Z = {0:0.1, 1:0, 2:0, 3:1, 4:1, 5:1, 6:0}
